...
use bdk_lite::bitcoin::util::bip32::ExtendedPrivKey;
use bdk_lite::bitcoin::Network;
use bdk_lite::blockchain::{Blockchain, ElectrumBlockchain};
use bdk_lite::database::MemoryDatabase;
use bdk_lite::template::Bip84;
use bdk_lite::wallet::export::FullyNodedExport;
use bdk_lite::{KeychainKind, SyncOptions, Wallet};

use bdk_lite::electrum_client::Client;
use bdk_lite::wallet::AddressIndex;
...
fn run(network: &Network, electrum_url: &str, xpriv: &str) {
    ...
    let export = FullyNodedExport::export_wallet(&wallet, "exported wallet", true)
        ...
        .map_err(bdk_lite::Error::Generic)
        .unwrap();

...
abstract class $InscriptionCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, int offset, int number});
}
...
class _$_Inscription implements _Inscription {
  _$_Inscription(
      {required this.id, required this.offset, required this.number});
  ...
  @override
  String toString() {
    return 'Inscription(id: $id, offset: $offset, number: $number)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, offset, number);
...
abstract class _Inscription implements Inscription {
  factory _Inscription(
      ...
      required final int number}) = _$_Inscription;

...
#[no_mangle]
pub extern "C" fn wire_keccak256_encode(port_: i64, req: *mut wire_KeccakReq) {
    wire_keccak256_encode_impl(port_, req)
}
...
#[no_mangle]
pub extern "C" fn new_box_autoadd_keccak_req_0() -> *mut wire_KeccakReq {
    support::new_leak_box_ptr(wire_KeccakReq::new_with_null_ptr())
}
...
impl Wire2Api<KeccakReq> for *mut wire_KeccakReq {
    fn wire2api(self) -> KeccakReq {
        let wrap = unsafe { support::box_from_leak_ptr(self) };
        Wire2Api::<KeccakReq>::wire2api(*wrap).into()
    }
}
...
impl Wire2Api<KeccakReq> for wire_KeccakReq {
    fn wire2api(self) -> KeccakReq {
        KeccakReq {
            message: self.message.wire2api(),
        }
...
impl NewWithNullPtr for wire_KeccakReq {
    fn new_with_null_ptr() -> Self {
        Self {
            message: core::ptr::null_mut(),
        }

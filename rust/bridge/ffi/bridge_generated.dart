...
abstract class AgentDart {
  ...
  /// keccak
  /// ----------------
  Future<Uint8List> keccak256Encode({required KeccakReq req, dynamic hint});

  FlutterRustBridgeTaskConstMeta get kKeccak256EncodeConstMeta;
}
...
class AgentDartImpl implements AgentDart {
  ...
  Future<Uint8List> mnemonicPhraseToSeed(
      ...
      _platform.executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) => _platform.inner.wire_mnemonic_phrase_to_seed(
            port_, _platform.api2wire_box_autoadd_phrase_to_seed_req(req)),
  ...
  Future<Uint8List> mnemonicSeedToKey(
          {required SeedToKeyReq req, dynamic hint}) =>
      _platform.executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) => _platform.inner.wire_mnemonic_seed_to_key(
            port_, _platform.api2wire_box_autoadd_seed_to_key_req(req)),
        parseSuccessData: _wire2api_uint_8_list,
  ...
  Future<bool> blsVerify({required BLSVerifyReq req, dynamic hint}) =>
      _platform.executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) => _platform.inner.wire_bls_verify(
            port_, _platform.api2wire_box_autoadd_bls_verify_req(req)),
        parseSuccessData: _wire2api_bool,
  ...
  Future<ED25519Res> ed25519FromSeed(
          {required ED25519FromSeedReq req, dynamic hint}) =>
      _platform.executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) => _platform.inner.wire_ed25519_from_seed(
            port_, _platform.api2wire_box_autoadd_ed_25519_from_seed_req(req)),
  ...
  Future<Uint8List> ed25519Sign({required ED25519SignReq req, dynamic hint}) =>
      _platform.executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) => _platform.inner.wire_ed25519_sign(
            port_, _platform.api2wire_box_autoadd_ed_25519_sign_req(req)),
        parseSuccessData: _wire2api_uint_8_list,
  ...
  Future<bool> ed25519Verify({required ED25519VerifyReq req, dynamic hint}) =>
      _platform.executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) => _platform.inner.wire_ed25519_verify(
            port_, _platform.api2wire_box_autoadd_ed_25519_verify_req(req)),
        parseSuccessData: _wire2api_bool,
  ...
  Future<Secp256k1IdentityExport> secp256K1FromSeed(
          {required Secp256k1FromSeedReq req, dynamic hint}) =>
      _platform.executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) => _platform.inner.wire_secp256k1_from_seed(port_,
            _platform.api2wire_box_autoadd_secp_256_k_1_from_seed_req(req)),
  ...
  Future<SignatureFFI> secp256K1Sign(
          {required Secp256k1SignWithSeedReq req, dynamic hint}) =>
      _platform.executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) => _platform.inner.wire_secp256k1_sign(
            port_,
            _platform
                .api2wire_box_autoadd_secp_256_k_1_sign_with_seed_req(req)),
  ...
  Future<bool> secp256K1Verify(
      ...
      _platform.executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) => _platform.inner.wire_secp256k1_verify(
            port_, _platform.api2wire_box_autoadd_secp_256_k_1_verify_req(req)),
        parseSuccessData: _wire2api_bool,
  ...
  Future<Uint8List> aes128CtrEncrypt(
          {required AesEncryptReq req, dynamic hint}) =>
      _platform.executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) => _platform.inner.wire_aes_128_ctr_encrypt(
            port_, _platform.api2wire_box_autoadd_aes_encrypt_req(req)),
        parseSuccessData: _wire2api_uint_8_list,
  ...
  Future<Uint8List> aes128CtrDecrypt(
          {required AesDecryptReq req, dynamic hint}) =>
      _platform.executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) => _platform.inner.wire_aes_128_ctr_decrypt(
            port_, _platform.api2wire_box_autoadd_aes_decrypt_req(req)),
        parseSuccessData: _wire2api_uint_8_list,
  ...
  Future<KeyDerivedRes> pbkdf2DeriveKey(
          {required PBKDFDeriveReq req, dynamic hint}) =>
      _platform.executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) => _platform.inner.wire_pbkdf2_derive_key(
            port_, _platform.api2wire_box_autoadd_pbkdf_derive_req(req)),
  ...
  Future<KeyDerivedRes> scryptDeriveKey(
          {required ScriptDeriveReq req, dynamic hint}) =>
      _platform.executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) => _platform.inner.wire_scrypt_derive_key(
            port_, _platform.api2wire_box_autoadd_script_derive_req(req)),
        parseSuccessData: _wire2api_key_derived_res,
  ...
  Future<Uint8List> keccak256Encode({required KeccakReq req, dynamic hint}) =>
      _platform.executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) => _platform.inner.wire_keccak256_encode(
            port_, _platform.api2wire_box_autoadd_keccak_req(req)),
        parseSuccessData: _wire2api_uint_8_list,
        constMeta: kKeccak256EncodeConstMeta,
        argValues: [req],
        hint: hint,
      ));
...
// Section: api2wire
  ...
  @protected
  ffi.Pointer<wire_KeccakReq> api2wire_box_autoadd_keccak_req(KeccakReq raw) {
    final ptr = inner.new_box_autoadd_keccak_req_0();
    _api_fill_to_wire_keccak_req(raw, ptr.ref);
    return ptr;
  }
...
// Section: api_fill_to_wire
  ...
  void _api_fill_to_wire_box_autoadd_keccak_req(
      KeccakReq apiObj, ffi.Pointer<wire_KeccakReq> wireObj) {
    _api_fill_to_wire_keccak_req(apiObj, wireObj.ref);
  }
  ...
  void _api_fill_to_wire_keccak_req(KeccakReq apiObj, wire_KeccakReq wireObj) {
    wireObj.message = api2wire_uint_8_list(apiObj.message);
  }
...
class AgentDartWire implements FlutterRustBridgeWireBase {
  ...
  void wire_keccak256_encode(
    int port_,
    ffi.Pointer<wire_KeccakReq> req,
  ) {
    return _wire_keccak256_encode(
      port_,
      req,
    );
  }

  late final _wire_keccak256_encodePtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Int64,
              ffi.Pointer<wire_KeccakReq>)>>('wire_keccak256_encode');
  late final _wire_keccak256_encode = _wire_keccak256_encodePtr
      .asFunction<void Function(int, ffi.Pointer<wire_KeccakReq>)>();
  ...
  ffi.Pointer<wire_KeccakReq> new_box_autoadd_keccak_req_0() {
    return _new_box_autoadd_keccak_req_0();
  }

  late final _new_box_autoadd_keccak_req_0Ptr =
      _lookup<ffi.NativeFunction<ffi.Pointer<wire_KeccakReq> Function()>>(
          'new_box_autoadd_keccak_req_0');
  late final _new_box_autoadd_keccak_req_0 = _new_box_autoadd_keccak_req_0Ptr
      .asFunction<ffi.Pointer<wire_KeccakReq> Function()>();
...
class wire_KeccakReq extends ffi.Struct {
  external ffi.Pointer<wire_uint_8_list> message;
}

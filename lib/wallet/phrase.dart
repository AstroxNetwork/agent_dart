...
class Phrase {
  ...
  static Phrase generate({int length = 24}) {
    ...
    if (length == 24) {
      ...
      throw PhaseException(message: "Phrase should be length 12 or 24");
    }
  ...
  Future<Uint8List> toSeed({String passphrase = ""}) async {
    return await AgentDartFFI.instance.mnemonicPhraseToSeed(
...
class PhaseException implements Exception {
  ...
  PhaseException({required this.message, this.wordList});

  @override
  String toString() {
    if (wordList != null) {
      return "PhaseException: $message, with words: $wordList";
    } else {
